        ...
        <form action="{{route('admin.movies.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input type="text" name="genre" id="genre" placeholder="Romantis, Comedy, Action, Horror, Thriller, etc" class="form-control @error('genre') is-invalid @enderror" >
                    @error('genre')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <input type="text" name="age_rating" id="age_rating" class="form-control @error('age_rating') is-invalid @enderror" >
                    @error('age_rating')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>

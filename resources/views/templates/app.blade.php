...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <div class="container">
            ...
            <a class="navbar-brand me-2" href="https://mdbgo.com/">
                <img src="https://play-lh.googleusercontent.com/tLaJ1U__i5vdc4TJFjsVVmu2e-K0zVtiOOhMZiqnS6BCvhpxG8rCC0hzeQuUKCtJ5g"
            ...
            <div class="collapse navbar-collapse" id="navbarButtonsExample">
                ...
                <div class="d-flex align-items-center">
                    @if (Auth::check())
                        {{-- Check Auth untuk menampilkan tombol logout --}}
                        <a href="{{ route('logout') }}" class="btn btn-danger">Logout</a>
                    @else
                        <a href="{{ route('log_in') }}" data-mdb-ripple-init type="button"
 ...
 @if (Session::get('accessDenied'))
            <div class="alert alert-danger">{{ Session::get('accessDenied') }}</div>
        @endif
